...
Diseño del motor de **Traducción Dinámica** (Español/Inglés) que permite el cambio de nombres de comandos en tiempo de ejecución.Sincronización del panel de ayuda (`ayuda`/`help`) según el contexto regional seleccionado.
